class Colibri::FeedbackReviewsController < Colibri::StoreController
  ...
  def create
    ...
    if @review.present?
      ...
      @feedback_review.locale = I18n.locale.to_s if Colibri::Reviews::Config[:track_locale]
  ...
  protected
    def load_review
      @review ||= Colibri::Review.find_by_id!(params[:review_id])
    end
