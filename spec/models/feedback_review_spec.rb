...
describe Colibri::FeedbackReview do
  ...
  context 'scopes' do
    context 'most_recent_first' do
      ...
      it 'properly runs most_recent_first queries' do
        Colibri::FeedbackReview.most_recent_first.to_a.should eq([feedback_review_2, feedback_review_3, feedback_review_1])
      end

      it 'defaults to most_recent_first queries' do
        Colibri::FeedbackReview.all.to_a.should eq([feedback_review_2, feedback_review_3, feedback_review_1])
      end
    end
    ...
    context 'localized' do
      ...
      it 'properly runs localized queries' do
        Colibri::FeedbackReview.localized('en').to_a.should eq([en_feedback_review_2, en_feedback_review_3, en_feedback_review_1])
        Colibri::FeedbackReview.localized('es').to_a.should eq([es_feedback_review_1])
        Colibri::FeedbackReview.localized('fr').to_a.should eq([fr_feedback_review_1])
      end
    end
  end
end
