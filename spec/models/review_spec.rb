  ...
  context 'scopes' do
    context 'most_recent_first' do
      ...
      it 'properly runs most_recent_first queries' do
        Colibri::Review.most_recent_first.to_a.should eq([review_2, review_3, review_1])
      end

      it 'defaults to most_recent_first queries' do
        Colibri::Review.all.to_a.should eq([review_2, review_3, review_1])
      end
    end
    ...
    context 'oldest_first' do
      ...
      it 'properly runs oldest_first queries' do
        Colibri::Review.oldest_first.to_a.should eq([review_1, review_3, review_2, review_4])
      end

      it 'uses oldest_first for preview' do
        Colibri::ReviewsConfiguration.new.reset
        Colibri::Review.preview.to_a.should eq([review_1, review_3, review_2])
      end
    end
    ...
    context 'localized' do
      ...
      it 'properly runs localized queries' do
        Colibri::Review.localized('en').to_a.should eq([en_review_2, en_review_3, en_review_1])
        Colibri::Review.localized('es').to_a.should eq([es_review_1])
        Colibri::Review.localized('fr').to_a.should eq([fr_review_1])
      end
    end
    ...
    context 'approved / not_approved / default_approval_filter' do
      ...
      it 'properly runs approved and unapproved queries' do
        Colibri::Review.approved.to_a.should eq([approved_review_2, approved_review_3, approved_review_1])
        Colibri::Review.not_approved.to_a.should eq([unapproved_review_2, unapproved_review_1])

        Colibri::Reviews::Config[:include_unapproved_reviews] = true
        Colibri::Review.default_approval_filter.to_a.should eq([unapproved_review_2, 
                                                              approved_review_2, 
                                                              approved_review_3, 
                                                              unapproved_review_1, 
                                                              approved_review_1])
        ...
        Colibri::Review.default_approval_filter.to_a.should eq([approved_review_2, approved_review_3, approved_review_1])
      end
    end
  end
